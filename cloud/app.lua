...
if msg == 2 then titleTv:setText("公告") else titleTv:setText("发现新版本") end
...
if msg == 2 then bodyTv:setText("• 服务器将于今晚22:00-23:00进行维护\n• 维护期间无法登录\n• 请提前安排游戏时间") else bodyTv:setText("• 修复已知问题，提升稳定性\n• 优化界面交互体验\n• 新增夜间模式\n• 修复闪退问题") end
...
okBtn:setOnClickListener(luajava.createProxy("android.view.View$OnClickListener", { onClick = function(v)
dialog:dismiss()
uo()
...
cancelBtn:setOnClickListener(luajava.createProxy("android.view.View$OnClickListener", { onClick = function(v)
dialog:dismiss()
if msg == 1 then
...
updateBtn:setOnClickListener(luajava.createProxy("android.view.View$OnClickListener", { onClick = function(v)
...
local scaleAnim = luajava.new(ScaleAnimation, 0.8, 1.0, 0.8, 1.0, Animation.RELATIVE_TO_SELF, 0.5, Animation.RELATIVE_TO_SELF, 0.5)
